...
namespace MinecraftClone.Common
{
    ...
    public class Texture
    {
        ...
        public static Texture LoadFromFile(string path)
        {
            ...
            // Now, set the wrapping mode. S is for the X axis, and T is for the Y axis. We set this to Repeat so that textures will repeat when wrapped. Not demonstrated here since the texture coordinates exactly match
